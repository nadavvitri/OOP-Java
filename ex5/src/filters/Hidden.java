...
/**
 * This class extend Filter class and represent the "hidden" filter - returns files that they are hidden.
 */
public class Hidden extends Filter {
     ...
     * "YES" or "NO".
     */
    public Hidden(String value,boolean isNot, int lineNum) throws Type1Exception {
    ...
    public boolean accept(File pathname) {
        if (pathname.isFile()) {
            if ((pathname.isHidden() && yes) || (!pathname.isHidden() && !yes)) {
                return true;}
        } return false;
    }
}
