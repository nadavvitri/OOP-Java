...
/**
 * This class extend Filter class and represent the "writable" filter - returns files that they have a write
 * permission.
 */
public class Writable extends Filter {
     ...
     * "YES" or "NO".
     */
    public Writable(String value, boolean isNot, int lineNum) throws Type1Exception {
    ...
    public boolean accept(File pathname) {
        if (pathname.isFile()){
            if ((pathname.canWrite() && yes) || (!pathname.canWrite() && !yes)){
                return true;}
        }return false;}
}
